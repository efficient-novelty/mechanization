...
- state space vs dynamics;
- law vs initial conditions;
- structural realism;
- primitive actuality;
- whole-history or global-consistency views.

Actions:

- Build a section that explains what each neighboring framework gets right and what explanatory gap remains.
- Explicitly show that constitutive constraint is not simply "state space" and selective actualization is not simply "dynamics."
- Explain why the proposal is not reducible to law plus initial conditions.
- Defend localizability without caricaturing holistic or whole-history alternatives.
