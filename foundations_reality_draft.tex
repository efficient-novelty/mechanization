...
\textbf{Selective Law:} the law of local actualization.
\end{quote}

The Selective Law does not require reality to inspect remote futures. It orders present coherent continuations by their intrinsic generative affordance relative to their stabilization burden, and world-history arises through recursive local actualization.
...
A third clarification concerns the scope of later work. The present paper does not introduce a specific formal evaluator, local-actualization rule, or cosmological mechanism. It argues only for the necessity of two ontological roles and for the structural form these roles must take. A later paper may propose a concrete formal candidate for the Selective Law, but that is not done here.
