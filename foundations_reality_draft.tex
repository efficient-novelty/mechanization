...
The immediate target is not every conceivable universe whatsoever, but any world stable enough to preserve determinate identity through change, dynamic enough to exhibit genuine becoming, and rich enough to sustain nontrivial historical articulation. On that target, the paper proceeds as follows. Section 2 clarifies method and scope. Section 3 argues that foundational explanation must separate constitutive admissibility from selective actualization. The subsequent sections develop each role in turn, explain why the selective role must be localizable, and conclude by distinguishing what is argued, what is proposed, and what is deferred.

\section{Method, scope, and presentation-independence}

The present argument concerns foundational explanation rather than any privileged implementation. It is not the claim that reality is literally ``written'' in any one human formalism, still less that the world is a proof assistant or that its source code can be identified with a particular syntactic calculus. Human logical systems are at best presentations of deeper invariant content. They matter here only insofar as they provide partial insight into what constitutive admissibility and selective actualization would have to preserve.
...
A second clarification concerns the word \emph{law}. In the present paper, talk of a foundational law is shorthand for a role in foundational explanation, not yet a contingent regularity of a particular physical cosmos. The question is what an adequate account must supply before one reaches the more familiar domain of physical lawhood in an already determinate world.

A third clarification concerns scope. The present paper does not introduce a specific formal evaluator, local-actualization rule, or cosmological mechanism. It argues only that foundational explanation must separate two roles and that these roles must have a certain structural shape. A later paper may propose a concrete formal candidate for selective actualization, but that is not done here.
...
\section{The Selective Law: local actualization}

The Constitutive Law yields a realm of coherent possibility. It does not yet yield reality as realized history. The task of the Selective Law is therefore not to replace the constitutive order, but to govern how actuality proceeds from within it.

Let $H$ denote realized history at some stage. Let $\mathcal{C}_{\mathrm{loc}}(H)$ denote the local continuation cone of coherent continuations of $H$ permitted by the Constitutive Law. The Selective Law is a rule on $\mathcal{C}_{\mathrm{loc}}(H)$. The question is: what structural features must such a rule possess if it is to generate a stable and interesting universe without hidden global foresight?
...
The Selective Law may therefore be path-dependent without becoming globally foresighted. It reads what is already structured into the present continuation cone.
...
Intrinsic generative affordance without stabilization collapses into uncontrolled branching. Stabilization without intrinsic generative affordance collapses into sterile conservation. A genuine Selective Law must therefore weigh both.
...
We may now state the Selective Law in canonical form.
...
\begin{remark}
A compressed formulation is useful. One may summarize the Selective Law by saying: \emph{reality becomes by least sufficient locally generative coherent expansion}. The fuller theorem should be preferred whenever precision matters.
\end{remark}
...
\subsection{Without localizability: teleology or opacity}
...
\subsection{Without commitment: no evolving world}
...
\subsection{Without intrinsic generative affordance: stagnation}
...
\subsection{Without stabilization burden: explosion}
...
\subsection{Without critical sufficiency: oversized jumps}
...
\subsection{Without constructive primeness: gratuitous bundling}
...
\subsection{Without coherent integration: no world-history}
...
Taken together, these constraints force the Selective Law into something close to the canonical statement given above. The exact later formalization may vary. The structural shape cannot vary far without the ontology collapsing into arbitrariness, stagnation, explosion, serial replacement, or computational opacity.
...
The Selective Law answers the question: \emph{what becomes actual?} It defines the order of realized history through recursive local actualization. In a broadly constructive register, it concerns the transition from form to fact, from candidate structure to inhabited actuality.

\begin{proposition}
The Constitutive Law is the law of admissibility. The Selective Law is the law of local actualization. Neither is reducible to the other.
\end{proposition}

\begin{proof}
The Constitutive Law specifies the candidate space but does not order local actualization within it. The Selective Law orders local actualization within the candidate space but does not create it. Reducing the first to the second leaves local actualization without ground; reducing the second to the first leaves actuality without articulation.
\end{proof}
