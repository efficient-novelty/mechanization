...
Please provide a concrete symbolic architecture and algorithmic plan for proof-state-first search with safe-closure discipline, premise retrieval, abstraction reuse, theorem-backed pruning, and strict invariance/leakage guarantees, targeting first-9-step correctness under 60 seconds without sequence injection
