...
In this manuscript, that requirement is not treated as optional library hygiene, but as a syntactic condition for foundational type theory itself: every new constructor, modality, or axiom schema must define its computational interaction with all eliminators already present in the active context telescope.
