...
At each step the engine also evaluates the step-indexed reference telescope as an explicit candidate (including Step~15 DCT), so selection is always among a finite, auditable candidate set rather than unconstrained search over the full binary space.
