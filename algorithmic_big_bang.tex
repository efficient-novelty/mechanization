...
\subsection{The $\rho = 11.00$ Efficiency Peak}
\label{sec:rho-spike}
...
\subsection{The $\nu = 88$ Explosion and the Inflationary Epoch}
...
The combinatorial amplification at Step~15 ($\nu = 88$, compared to $\nu \leq 63$ at all prior steps) is a necessary precondition for any physical inflationary dynamics.
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{The inflationary epoch} is the combinatorial schema explosion ($\nu = 88$) produced by the sudden cross-interaction of 14~previously disconnected kinematic structures.
