...
#
# Runs `cabal run ab-initio -- --strict --csv /tmp/pen_table.csv`
...
echo "Running ab-initio in strict mode..." >&2
cabal run ab-initio -- --strict --csv "$CSV_FILE" >/dev/null 2>&1
...

{
  ...
  echo '% Source: cabal run ab-initio -- --strict'
